# Rserpapi.parse.searchSingle.json.r
## Parse single JSON (PROD) ####

#' Parse output from Rserpapi.get.searchSingle.json
#'
#' @param data Output from Rserpapi.get.searchSingle.json.

Rserpapi.parse.searchSingle.json <- function(data) {
  ...
  asDataFrameResult <- function(x) {
    ...
    # Function to prepare empty data frame based on giben schema. Uses "schemas" definitions from above".
